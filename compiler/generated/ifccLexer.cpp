...
std::vector<std::string> ifccLexer::_ruleNames = {
  ...
  u8"T__7", u8"RETURN", u8"CONST", u8"VARIABLE", u8"COMMENT", u8"DIRECTIVE", 
  u8"WS"
};
...
std::vector<std::string> ifccLexer::_symbolicNames = {
  "", "", "", "", "", "", "", "", "", u8"RETURN", u8"CONST", u8"VARIABLE", 
...
ifccLexer::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x30, 0x31, 0x7, 0x3f, 0x2, 0x2, 0x31, 0x10, 0x3, 0x2, 0x2, 0x2, 0x32, 
    0x33, 0x7, 0x3d, 0x2, 0x2, 0x33, 0x12, 0x3, 0x2, 0x2, 0x2, 0x34, 0x35, 
